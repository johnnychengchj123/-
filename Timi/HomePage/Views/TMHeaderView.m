...
- (UIButton *)createBtn
{
    if (!_createBtn) {
        ...
        button.layer.cornerRadius =(kCircleWidth-30-30)/2;//kCircleWidth-30-30
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.createBtn makeConstraints:^(MASConstraintMaker *make) {
            make.edges.equalTo(weakSelf.pieView).insets(UIEdgeInsetsMake(5, 5, 5, 5));
        }];
        ...
        [self bringSubviewToFront:self.createBtn];
